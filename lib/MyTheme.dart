...
class MyTheme {
  ...
  static Color readColor = Color(0xffC91C22);
  ...
  static ThemeData ligthTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleMedium: TextStyle(
          fontSize: 20, fontWeight: FontWeight.bold, color: MyTheme.blackColor),
      titleSmall: TextStyle(
          fontSize: 18, fontWeight: FontWeight.bold, color: MyTheme.blackColor),
    ),
  );
}
